package club.anlan.lanlife.redis.util;

import club.anlan.lanlife.base.util.DateUtil;
import club.anlan.lanlife.redis.base.AbstractRedisCache;
...
@Component
@Slf4j
public class RedisStringUtil extends AbstractRedisCache<String, String> {
